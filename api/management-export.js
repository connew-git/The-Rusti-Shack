// Private endpoint — CSV downloads for the management dashboard.
// Session validated via signed cookie — see lib/management-auth.js.
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    console.error('management-export error:', err);

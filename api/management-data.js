// Private endpoint — management dashboard data.
// Session validated via signed cookie before any data is returned — see
// lib/management-auth.js. Identical business logic to Part B's
// manager-data.js; only the auth check changed.
